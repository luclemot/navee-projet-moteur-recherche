...
fe = feature_extractor(
    model_path="feature_extractor/models/feature_extractor_90_256.json",
    weights_path="feature_extractor/models/feature_extractor_90_256.h5",
)
...
def get_similar_item(img, lsh_variable, n_items=5, url=False):
    ...
    # print(vect)
    response = lsh_variable.query(
        vect, num_results=n_items + 1, distance_func="euclidean"
    )
